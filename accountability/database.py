...
class Database:
    ...
    def get_activities_for_date_range(self, start_date, end_date):
        ...
        """
        # Start and end of the day
        start_day = datetime(start_date.year, start_date.month, start_date.day, 0, 0, 0).isoformat()
        end_day = datetime(end_date.year, end_date.month, end_date.day, 23, 59, 59).isoformat()
